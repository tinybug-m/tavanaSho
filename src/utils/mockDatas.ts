...
export const CUSTOMERS_MOCK_DATA: CustomerProps[] = [
  {
    id: 0,
...
export const APP_PAGES = ['ارتباط با ما', 'تماس با ما', 'مقالات', 'خدمات تواناشو', 'دوره ها'];
...
export const MENU_ITEMS: MenuItemsProps[] = [
  {
    title: 'دوره ها',
    sub: ['خودشناسی', 'هوش هیچانی در روابط', 'هوش اجتماعی در مجیط کار', 'روابط عاشقانه'],
  },
  {
    title: 'مقالات آموزشی',
